...
def get_next_session(
    ...
    return {
        "patient_id": patient_id,
        "method": "rule_based",
        "recommendation": recommend_session(
            analytics
        ),
    }
...
def voice_command(
    ...
    """Text-first voice intent fallback."""
    ...
    intents = {
        "start memory game": "start_memory",
        "play memory game": "start_memory",
        "play attention game": "start_attention",
        "start attention game": "start_attention",
        "start pattern game": "start_pattern",
        "play pattern game": "start_pattern",
        "read my reminders": "read_reminders",
        "what is my next reminder": "read_reminders",
        "help": "help",
        "repeat": "repeat",
    }
    ...
    intent = next(
        (
            value
            for phrase, value in intents.items()
            if phrase in text
        ),
        "unknown",
    )
    ...
    responses = {
        "start_memory": (
            "Open the Memory Game to begin."
        ),
        "start_attention": (
            "Open the Attention Game to begin."
        ),
        "start_pattern": (
            "Open the Pattern Game to begin."
        ),
        "read_reminders": (
            "Your reminders are available "
            "on the Reminders screen."
        ),
        "help": (
            "You can ask to start a game "
            "or read your reminders."
        ),
        "repeat": (
